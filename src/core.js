...
function remainingBakeTime(bakedfor) {
  let remaining = bakingTime() - bakedfor
  return remaining
}
...
function totalTimeSpent(layers, bakedfor) {
  return calculatePreparationTime(layers) + bakedfor
}
